...
// console.log(ELEMENT_SEARCH_BUTTON);
// console.log(ELEMENT_SEARCHED_BUTTON);
// console.log(ELEMENT_LOADING_TEXT);
// console.log(ELEMENT_WEATHER_BOX);
// console.log(ELEMENT_WEATHER_CITY);
// console.log(ELEMENT_WEATHER_DESCRIPTION);
